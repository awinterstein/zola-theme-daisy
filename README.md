...
A beautiful and fast [Zola](https://www.getzola.org/) theme build on [TailwindCSS](https://tailwindcss.com) and [DaisyUI](https://daisyui.com).

![Screenshot](screenshot.png)

[Google PageSpeed](https://pagespeed.web.dev/analysis/https-zola-daisy-netlify-app/udn2dhb2yi)
